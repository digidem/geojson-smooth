...
function createPathContext (lineCurveFactory, polygonCurveFactory) {
...
var geoCurveCardinal = ((function custom (tension) {
...
var geoCurveCatmullRom = ((function custom (alpha) {
...
var geoCurveLinear = function (context) {
  return new PathContext(context)
};

var PathContext$1 = createPathContext(curveBasis, curveBasisClosed);

var geoCurveBasis = function (context) {
  return new PathContext$1(context)
};

exports.geoCurveCardinal = geoCurveCardinal;
exports.geoCurveCatmullRom = geoCurveCatmullRom;
exports.geoCurveLinear = geoCurveLinear;
exports.geoCurveBasis = geoCurveBasis;
